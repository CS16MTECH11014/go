...
@0 = internal global [11 x i8] c"hello world"
...
.0.entry:                                         ; preds = %prologue
  ...
  %8 = call i8* @__go_new(i8* nest undef, i8* getelementptr inbounds (%commonType, %commonType* @__go_tdn_string, i32 0, i32 0), i64 16), !dbg !14
  %9 = bitcast i8* %8 to { i8*, i64 }*, !dbg !14
  store { i8*, i64 } { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @0, i32 0, i32 0), i64 11 }, { i8*, i64 }* %9, !dbg !14
  %10 = bitcast { i8*, i64 }* %9 to i8*, !dbg !14
  %11 = insertvalue { i8*, i8* } { i8* getelementptr inbounds (%commonType, %commonType* @__go_tdn_string, i32 0, i32 0), i8* undef }, i8* %10, 1, !dbg !14
  %12 = bitcast i8* %7 to { i8*, i8* }*, !dbg !14
  store { i8*, i8* } %11, { i8*, i8* }* %12, !dbg !14
  ...
  store { i8*, i64, i64 } %16, { i8*, i64, i64 }* %1, !dbg !15
  call void @fmt.Println({ i64, { i8*, i8* } }* sret %2, i8* nest undef, { i8*, i64, i64 }* byval %1), !dbg !15
  %17 = getelementptr inbounds { i64, { i8*, i8* } }, { i64, { i8*, i8* } }* %2, i32 0, i32 0, !dbg !15
  %18 = load i64, i64* %17, !dbg !15
  %19 = getelementptr inbounds { i64, { i8*, i8* } }, { i64, { i8*, i8* } }* %2, i32 0, i32 1, !dbg !15
  %20 = load { i8*, i8* }, { i8*, i8* }* %19, !dbg !15
  ret void, !dbg !14
}
...
!1 = !DIFile(filename: "go_programs/hello.go", directory: "/home/arpit/IIT/Project/cbmc_llvm/sample_go_programs")
!2 = !{}
...
!10 = distinct !DISubprogram(name: "main.main", linkageName: "main.main", scope: null, file: !11, line: 7, type: !6, isLocal: false, isDefinition: true, isOptimized: false, unit: !0, variables: !2)
!11 = !DIFile(filename: "go_programs/hello.go", directory: "")
!12 = !DILocation(line: 7, column: 6, scope: !10)
!13 = !DILocation(line: 8, column: 30, scope: !10)
!14 = !DILocation(line: 0, scope: !10)
!15 = !DILocation(line: 8, column: 16, scope: !10)
