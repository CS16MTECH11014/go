go_programs directory contains different go programs and llvm_ir_readable dir contains respective LLVM IR (in human readable format) with the file names same as Go programs.
